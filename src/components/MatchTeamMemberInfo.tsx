...
import { MatchTeamMember } from "@/model";
...
interface Props {
  data: MatchTeamMember;
  nickname: string;
  loading: boolean;
  error: ApolloError | undefined;
}

const MatchTeamMemberInfo: FunctionComponent<Props> = (props) => {
          ...
          {data.matchTeamMember[0].players.map((item) => (
            <MemberCard
              ...
              style={{
                ...
                ...isMine(item.characterName, "Team1", nickname),
              }}
            >
              <div
                style={{
          ...
          {data.matchTeamMember[1].players.map((item) => (
            <MemberCard
              ...
              style={{
                ...
                ...isMine(item.characterName, "Team2", nickname),
              }}
            >
              <div
                style={{
...
export default MatchTeamMemberInfo;
